...
if __name__ == '__main__':
    ...
    #データセットを読み込む
    dataset = LoadImages("../dataset/images", transform=get_transform(image_size))  #インスタンス生成
    #dataset = datasets.ImageFolder(root="../dataset/images", transform=get_transform(224))
